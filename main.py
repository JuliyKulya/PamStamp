...
def open_file():
    major_file = fd.askopenfilename(initialdir='C:/Users/juliy/PycharmProjects/PamStamp/String',
                                    title='Open major string file')
    major_file = open(major_file, "r")
    minor_file = fd.askopenfilename(initialdir='C:/Users/juliy/PycharmProjects/PamStamp/String',
                                    title='Open minor string file')
    minor_file = open(minor_file, "r")

    #Ignore firs line export for each file
    next(major_file)
    next(major_file)
    next(minor_file)
    next(minor_file)
